...
def game_loop():
    ...
    initialTimer = 2     # Initial time for game to start
    ...
    collision_4 = [None, None, None, None, None, None, None, None, None, None,None,None]
    ...
    found_4 = [None, None, None, None, None, None, None, None, None, None]
    ...
    temp_4 = [True, True, True, True, True, True, True, True, True, True]
    ...
    while not gameExit:
        ...
        if gameStarts == False:
            if initialTimer != 0:
                ...
                temp_4 = [None, None, None, None, None, None, None, None, None, None]
